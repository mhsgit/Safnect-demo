...
import vac.test.bluetoothbledemo.log.CrashHandler;
import vac.test.bluetoothbledemo.log.CustomUncaughtExceptionHandler;
import vac.test.bluetoothbledemo.log.LogToFile;
import vac.test.bluetoothbledemo.log.MyDiskLogStrategy;
