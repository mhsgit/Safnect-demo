...
interface IMpc {
     ...
     */
    suspend fun sendTransaction(role :String, data_path_prefix : String, receiver : String, amount :Double, currency :String,testnet : Boolean = true) :ByteArray?
     ...
     * 查询持仓信息
     */
    suspend fun getMyAssets(sender: String,testnet : Boolean): WalletMessage.GetAssetResult?


    /**
     * 查询交易信息
     */
    suspend fun getTransactionList(address: String,testnet : Boolean): WalletMessage.GetTransactionResult?

    /**
     * 查费率
     */
    suspend fun getEstimateGasFee(): String?
