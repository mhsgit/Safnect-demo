...
interface IBTListener{
    ...
    fun onDKGCommonMsg(opRespStatus : Int)
    fun onTransactionCommonMsg(opRespStatus : Int)
    fun onTransactionOtherComplete()
    fun onDKGOtherComplete()

    // 流程结束处理
    fun onFlowPathComplete()
